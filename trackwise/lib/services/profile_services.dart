...
class ProfileService {
  ...
  void updateUserProfile(UserProfile updatedProfile) {
    ...
    print('Profile updated: ${updatedProfile.name}, ${updatedProfile.email}, ${updatedProfile.phone}, ${updatedProfile.address}');
  }
}
